...
abstract class TranslationService {
  String? get(String key, BuildContext context, {List<String>? args});
}

class Translator implements TranslationService {
  @override
  String? get(String key, BuildContext context, {List<String>? args}) {
    return Translations.of(context)?.get(key, args: args);
  }
}
...
class Translations {
  ...
  String get(String key, {List<dynamic>? args}) {
    if (_localizedStrings[key] == null) return "${locale.languageCode}[$key]";
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<Translations> {
  ...
  bool isSupported(Locale locale) {
    ...
    return AppConstants.appLanguages.contains(locale.languageCode);
  }
